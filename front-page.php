			...
			<div class="apresenta-protecao">
				<div class="row">
					<div class="col-md-4 text-center">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo/protecao-w.png"
						     class="img-adptive" alt="Proteção de Dados Pessoais">
					</div>
					<div class="col-md-8 white">
						...
						<p>Esta lei tem por objetivo garantir e proteger, no âmbito do tratamento de dados pessoais, a
							dignidade e os direitos fundamentais da pessoa, particularmente em relação à sua liberdade,
							igualdade e privacidade pessoal e familiar, nos termos do art. 5º, incisos X e XII da
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<p class="text-center mt-lg fontsize-lg">
								<a href="<?php echo dadospessoais_get_english_information_link(); ?>"
								   class="font-roboto"><img
										src="<?php echo get_stylesheet_directory_uri(); ?>/images/english.png"
										class="mr-xs"> English information</a></p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-6 participe">
					<div class="contexto white">
						...
						if ( $page_participe ) {
							...
							<p class="mt-md">
								<a href="<?php echo get_permalink( $page_participe->ID ); ?>"
								   class="btn btn-danger btn-lg font-roboto">Participe do debate!</a>
							</p>
						<?php } ?>
					</div>
				</div>
				<div class="col-md-6 sobretexto">
					<div class="contexto white">
						...
						if ( $page_anteprojeto ) {
							...
							<p class="mt-md">
								<a href="<?php echo get_permalink( $page_anteprojeto ); ?>"
								   class="btn btn-primary btn-lg font-roboto">Comente o texto do Anteprojeto</a>
							</p>
						<?php } ?>
					</div>
				</div>
